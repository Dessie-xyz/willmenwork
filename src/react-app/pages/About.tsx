  ...
  return (
    <div>
      <div style={{ textAlign: "center" }}>
        ...
        <b>However, I need your help.</b> Despite my unchallenged intellect and impeccable branding skills, I’m just one idiot and can’t find all of the highest quality content by myself. That’s why community engagement is a core value of Weak Submissive Men. We encourage anyone who has any contributions or suggestions reach out using the means listed on our <Link to="/submit">submissions page</Link>. Though this website’s creation may have been unplanned, I promise mommy still loves you very much. 
        <br/><br/>
        With much love,
        <br />Red</p><br/>
        <h2>Our Mission</h2>
